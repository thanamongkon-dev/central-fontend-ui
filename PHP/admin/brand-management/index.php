...
<body class="container flex flex-col min-h-screen p-6 mx-auto font-sans bg-gray-50">
    ...
    <div class="mb-4 space-x-2">
        ...
        <!-- เพิ่มปุ่ม import -->
        <button onclick="importExcelData()" class="ml-2 btn btn-info">Import Excel Data</button>
